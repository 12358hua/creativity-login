...
const LargeBoatBeach = () => {
  ...
  const icons = useMemo(() => {
    return [
      ...
      // large boat: centered, anchor lowered into the sea
      { icon: Sailboat, color: 'darkorange', position: [190, 135], scale: 8 },
    ].map(({ icon, color, ...rest }) => {
